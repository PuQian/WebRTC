(function(){
    com.webrtc.Block = Object.subClass({
        /** @Public Methods*/
        ctor:function(blockSize,buffer,verified){
            /** @private members*/
            this.blockSize = blockSize; //numOfBytes
            this.length = Math.ceil(this.blockSize/com.webrtc.config.CHUNK_SIZE); //numOfChunks
...
//        },
        ...
        getChunk:function(chunkOffset){
            // if(this.verified){
                    if(this.buffer){
                        var startOffset = chunkOffset*com.webrtc.config.CHUNK_SIZE; //inclusive
                        var endOffset = (1+chunkOffset)*com.webrtc.config.CHUNK_SIZE; //exclusive
        ...
        setChunk:function(chunkOffset,chunkData){
            ...
            var byteOffset = chunkOffset*com.webrtc.config.CHUNK_SIZE;
